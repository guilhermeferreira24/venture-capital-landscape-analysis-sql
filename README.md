...
- **CTE (Common Table Expression)** is a temporary, named result set created with the `WITH` keyword that acts as a building block for the main query, making complex SQL easier to read and debug.
